                ...
                <div class="row gy-5">
                    <div class="col-xl-4">
                        <div class="profile__thumb__edit text-center custom--card">
                            <div class="card--body">
                                <div class="thumb">
                                    <img src="/assets/images/account/user.png" alt="testimonial">
                                </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text text--base">+192</span>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form--control style-two pt-3" placeholder="I'm a Front-end Web Developer. ...."></textarea>
                                        </div>
                                    </div>
                                    <div class="col">
