...
<!-- inner hero section end -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="sign-in.blade.php" class="cmn--btn active mt-sm-5 mt-4">Get Started</a>
                </div>
                <div class="col-lg-6">
                    <div class="aobut-thumb section-thumb">
                        <img src="/assets/images/about/thumb2.png" alt="about" class="ms-lg-5">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="why-section padding-top padding-bottom overflow-hidden bg_img" style="background: url(/assets/images/top/bg.png);">
        <div class="container">
